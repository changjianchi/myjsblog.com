...
lhgdialog.fn = lhgdialog.prototype =
{
	...
	{
		var _that=this;
		//this.DOM.wrap.fadeIn(600);
		//_that.DOM.wrap[0].style.visibility = 'visible';
		this.DOM.wrap[0].style.display='block';
		this.DOM.wrap.animate({opacity:1},600);
	...
	_getDOM: function()
	{
		...
		wrap.style.cssText = 'position:absolute;left:0;top:0;opacity:0;';
