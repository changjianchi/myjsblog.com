...
init('bgschool',($("#bgschool").data('per')),'#txtschool','#fbc348');
init('bgenvironmental',($("#bgenvironmental").data('per')),'#txtenvironmental','#fbc348');
init('bglives',($("#bglives").data('per')),'#txtlives','#fbc348');
...
function initsj(b,n,t,c){
	...
	//把底图先画上去 
	this.paper.image("../img/ht_mydpc.png", 0, 0, 60, 60); 
	//进度比例，0到1，在本例中我们画65% 
	//需要注意，下面的算法不支持画100%，要按99.99%来画 
	var percent = n	, 
		drawPercent = percent >= 1 ? 0.9999 : percent; 
...
initsj('bgschoolsj',($("#bgschoolsj").data('per')),'#txtschoolsj','#fbc348');
initsj('bgenvironmentalsj',($("#bgenvironmentalsj").data('per')),'#txtenvironmentalsj','#fbc348'); 
initsj('bglivessj',($("#bglivessj").data('per')),'#txtlivessj','#fbc348');  
