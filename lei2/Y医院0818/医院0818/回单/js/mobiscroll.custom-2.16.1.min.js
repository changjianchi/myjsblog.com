...
(function (a, b) {
    ...
    function c(c, e, d) {
        ...
        "string" === typeof e && c.each(function () {
            var a;
            if ((a = h[this.id]) && a[e])
                if (a = a[e].apply(this, Array.prototype.slice.call(d, 1)), a !== b) return f = a, !1
        });
        return f
    }
...
(function (a, b, d, c) {
    ...
    f.classes.Frame = function (h, r, w) {
        ...
        var u, z, X, C, T, l, J, y, O, p, E, R, S, G, P, Z, I, Q, V, K, ca, U, ha, ia, B = this,
            ea = a(h),
            ga = [],
            aa = {};
        f.classes.Base.call(this, h, r, !0);
        B.position = function (b) {
            var e, f, h, g, i, j, q, m, oa, t, n = 0,
                o = 0;
            oa = {};
            var p = Math.min(y[0].innerWidth || y.innerWidth(), l.width()),
                r = y[0].innerHeight || y.innerHeight();
            if (!(ha === p && ia === r && b || V))
                if ((B._isFullScreen ||
                    ...
                    B.scrollLock = ca;
                    "modal" == K.display ?
                        (f = Math.max(0, f + (p - Z) / 2), h = b + (r - I) / 2) : "bubble" == K.display ? (t = !0, m = a(".dw-arrw-i", C), h = g.offset(), j = Math.abs(z.offset().top - h.top), q = Math.abs(z.offset().left - h.left), i = g.width(), g = g.height(), f = k(q - (J.width(!0) - i) / 2, f + 3, f + p - Z - 3), h = j - I, h < b || j > b + r ? (J.removeClass("dw-bubble-top").addClass("dw-bubble-bottom"), h = j + g) : J.removeClass("dw-bubble-bottom").addClass("dw-bubble-top"), m = m.width(), i = k(q + i / 2 - (f + (Z - m) / 2), 0, m), a(".dw-arr", C).css({
                            left: i
                        })) : "top" == K.display ? h = b : "bottom" == K.display &&
                        (h = b + r - I);
                    h = 0 > h ? 0 : h;
                    oa.top = h;
                    oa.left = f;
        ...
        B.show = function (e, d) {
            ...
            if (!K.disabled && !B._isVisible) {
                ...
                h = '<div lang="' + K.lang + '" class="mbsc-' + K.theme + (K.baseTheme ? " mbsc-" + K.baseTheme : "") + " dw-" + K.display + " " + (K.cssClass || "") + (B._isLiquid ? " dw-liq" : "") + (q ? " mbsc-old" : "") + (G ? "" : " dw-nobtn") + '"><div class="dw-persp">' + (P ? '<div class="dwo"></div>' : "") + "<div" + (P ? ' role="dialog" tabindex="-1"' :
                    "") + ' class="dw' + (K.rtl ? " dw-rtl" : " dw-ltr") + '">' + ("bubble" === K.display ? '<div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div>' : "") + '<div class="dwwr"><div class="riqi-bt">出生日期</div><div class="yue-ri"><i>月</i><i>日</i></div><div aria-live="assertive" class="dw-aria dw-hidden"></div>' + (K.headerText ? '<div class="dwv">' + (n(K.headerText) ? K.headerText : "") + "</div>" : "") + '<div class="dwcc">';
    ...
    h.ListView = function (m, H) {
        ...
        function s(a) {
            var c = !1,
                b = !0;
            if (ma)
                if (sb = n(a, "X"), Gb = n(a, "Y"), la = sb - Pb, Ga = Gb - Qb, clearTimeout(cb), !Xa && !kb && !wb && !Y.hasClass("mbsc-lv-back") && (10 < Math.abs(Ga) ? (wb = !0, Y.trigger("mousemove" == a.type ? "mouseup" : "touchend"), clearTimeout(ka)) : 7 < Math.abs(la) ? z() : "touchmove" === a.type && (cb = setTimeout(function () {
                        Y.trigger("touchend")
                    }, 300))), kb) a.preventDefault(), qa = 100 * (la / bb), X();
                else if (Xa) {
                a.preventDefault();
                var d, e = Ia.scrollTop(),
                ...
                if (lb && (W.sortable.multiLevel && ua.hasClass("mbsc-lv-parent") ? Ma + Ea / 4 + a > lb ? c = !0 : Ma + Ea - Ea / 4 + a > lb && (Ja = ua.addClass("mbsc-lv-item-hl"), b = !1) : Ma + Ea / 2 + a > lb && (ua.hasClass("mbsc-lv-back") ? W.sortable.multiLevel && (na = ua.addClass("mbsc-lv-item-hl"), b = !1) : c = !0), c)) db.insertAfter(ua), Oa = ua, ua = B(ua, "next"), mb = lb, lb = ua.length && ua[0].offsetTop,
                    Ba++;
                if (!c && mb && (W.sortable.multiLevel && Oa.hasClass("mbsc-lv-parent") ? Ma + Ea - Ea / 4 + a < mb ? c = !0 : Ma + Ea / 4 + a < mb && (Ja = Oa.addClass("mbsc-lv-item-hl"), b = !1) : Ma + Ea / 2 + a < mb && (Oa.hasClass("mbsc-lv-back") ? W.sortable.multiLevel && (na = Oa.addClass("mbsc-lv-item-hl"), b = !1) : c = !0), c)) db.insertBefore(Oa), ua = Oa, Oa = B(Oa, "prev"), lb = mb, mb = Oa.length && Oa[0].offsetTop + Oa.height(), Ba--;
        ...
        function X() {
            ...
            if (!Tb) {
                if (Ca.actions) Da.attr("class", "mbsc-lv-stage-c-v mbsc-lv-stage-c mbsc-lv-" + (0 > qa ? "right" :
                    "left"));
                else if (tb && qa <= tb.percent ? (Ra--, ub = tb, tb = Fb[Ra], a = !0) : ub && qa >= ub.percent && (Ra++, tb = ub, ub = Fb[Ra], a = !0), a)
                    if (Ka = 0 < qa ? tb : ub) Z(Ka, ba.iconSlide), Aa("onStageChange", [Y, sa, Ka]);
                yb || (Tb = !0, jc = r(E))
            }
        }
        ...
        function C(c) {
            ...
            else if (ba.quickSwipe && !yb && (f = new Date - hc, b = 300 > f && -50 > la, f = 300 > f && 50 < la, b ? (Mb = !0, Ka = Ca.left, Z(Ka, ba.iconSlide)) : f && (Mb = !0, Ka = Ca.right, Z(Ka, ba.iconSlide))), Ka && Ka.action) Sa = K(Ka.disabled, [Y, sa, W]), Sa || (h = !0, (e = yb || K(Ka.confirm, [Y, sa, W])) ? (S(Y, 100 * (0 > qa ? -1 : 1) * Fa.width(!0) / bb, 200, !0), p(Ka, Y, sa, !1, c)) : O(Ka, Y, sa, c));
            h || R(Y, !0, c);
            kb = !1
        }
        ...
        function T() {
            ...
            Oa = B(Y, "prev");
            mb = Oa.length && Oa[0].offsetTop + Oa.height();
            db.height(Ea).insertAfter(Y);
            Y.css({
                top: Ma
            }).addClass("mbsc-lv-item-dragging").removeClass("mbsc-lv-item-active").appendTo(Va);
            Aa("onSortStart", [Y, Ba])
        }
...
sa]), c && c())
        ...
        var ma, ya, ka, qa, oa, La, hb, za, Ba, ra, ja, ob, pb, Eb, Ka, Ra, Wa, Za, Sa, la, Ga, Ja, na, Xa, Va, cb, sb, Gb, Aa, xa, fb, va, Bb, Cb, Xb, x, Ua, nb, Jb, Ha, zb, Ya, gb, Ib, Ta, ab, pa, Fa, Da, bb, Y, Ea, sa, qb, jb, rb, Pa, ua, lb, ub, Zb, Lb, Nb, ic, $b, db, Oa, mb, tb, Mb, jc, Tb, ba, wb, yb, bc, dc, Fb, gc, hc, Pb, Qb, $a, kb, ec, Yb, Sb, Rb, Ca, vb, Ub, Vb, Ia, Hb, xb, ac, W = this,
            Qa =
            m,
            Na = a(Qa),
            ib = 0,
        ...
        W.add = function (b, e, d, f, h, g) {
            ...
            L(t, function (b) {
                ...
                U(t.addClass(m));
                if (d !== false)
                    if (k) d < k ? t.insertBefore(l.eq(d)) : t.insertAfter(l.eq(k - 1));
                    else {
                        i = a(".mbsc-lv-back", n);
                        i.length ? t.insertAfter(i) : n.append(t)
                    }
                if (n.hasClass("mbsc-lv-v")) W.animate(t.height(t.height()), g && Ub === r ? "none" : "expand", function (a) {
        ...
        W.remove = function (a, c, b, e) {
            ...
            a.length && (f = a.parent(), d = ha(f).index(a), e || (a.attr("data-ref") === Ub && (Vb = !0), W.addUndoAction(function (c) {
                ...
                if (f.hasClass("mbsc-lv-v")) W.animate(a.addClass("mbsc-lv-removed"), e ? "pop-out" : "remove-" + c, function (a) {
                    W.animate(a.height(a.height()), "collapse",
                        function (a) {
            ...
            s.tap(a(".mbsc-np-btn", e), function () {
                ...
                if (b.hasClass("mbsc-np-btn-custom")) {
                    ...
                    if (!b.hasClass("dwb-d")) {
                        ...
                        if (e.length + r <= m)
                            for (b = 0; b < e.length; ++b) z.push("digit"), t.push(c(e[b]) ? +e[b] : e[b]);
                        o(!0)
                    }
        ...
        var h = a.extend({}, g.settings),
            ...
            o = {
                h: j.hourTextShort.replace(/d/g,
                    "\\d"),
                m: j.minuteTextShort.replace(/d/g, "\\d"),
                s: j.secTextShort.replace(/d/g, "\\d")
            },
    ...
    a.mobiscroll.presets.numpad.time = function (d) {
        ...
        return {
            ...
            validate: function (a, b) {
                ...
                if (a.length == m)
                    for (m = 0; 9 >= m; ++m) z.push(m);
                else if (1 == a.length && h && 1 == a[0] || a.length && 0 === a.length % 2 || !h && 2 == a[0] &&
                    3 < a[1] && 1 == a.length % 2)
                    for (m = 6; 9 >= m; ++m) z.push(m);
                N = void 0 !== a[1] ? "" + a[0] + a[1] : "";
                v = +A == +(void 0 !== a[3] ? "" + a[2] + a[3] : 0);
                if (g.invalid)
                    for (m = 0; m < g.invalid.length; ++m)
                        if (o = g.invalid[m].getHours(), s = g.invalid[m].getMinutes(), u = g.invalid[m].getSeconds(), o == +N)
                            if (2 == f.length && (10 > s ? 0 : +("" + s)[0]) == +a[2]) {
                                z.push(10 > s ? s : +("" + s)[1]);
                                break
                ...
                if (g.min || g.max) {
                    ...
                    if (0 === a.length) {
                        for (m = h ? 2 : 19 < k ? k[0] : 3; m <= (1 == k[0] ? 9 : k[0] -
                                1); ++m) z.push(m);
                        if (10 <= k && (z.push(0), 2 == k[0]))
                            for (m = 3; 9 >= m; ++m) z.push(m);
                        if (n && 10 > n || k && 10 <= k)
                            for (m = n && 10 > n ? +n[0] + 1 : 0; m < (k && 10 <= k ? k[0] : 10); ++m) z.push(m)
                    }
                    if (1 == a.length) {
                        if (0 === a[0])
                            for (m = 0; m < k[0]; ++m) z.push(m);
                        if (k && 0 !== a[0] && (h ? 1 == a[0] : 2 == a[0]))
                            for (m = h ? 3 : 4; 9 >= m; ++m) z.push(m);
                        if (a[0] == k[0])
                            for (m = 0; m < k[1]; ++m) z.push(m);
                        if (a[0] == n[0] && !h)
                            for (m = +n[1] + 1; 9 >= m; ++m) z.push(m)
                    }
                    if (2 == a.length && (o || N))
                        for (m = N ? +A[0] + 1 : 0; m < (o ? +q[0] : 10); ++m) z.push(m);
                    if (3 == a.length && (N && a[2] == A[0] || o && a[2] == q[0]))
                        for (m = N && a[2] ==
                            A[0] ? +A[1] + 1 : 0; m < (o && a[2] == q[0] ? +q[1] : 10); ++m) z.push(m);
                    if (4 == a.length && (v || s))
                        for (m = s ? +F[0] + 1 : 0; m < (v ? +D[0] : 10); ++m) z.push(m);
                    if (5 == a.length && (v && a[4] == D[0] || s && a[4] == F[0]))
                        for (m = s && a[4] == F[0] ? +F[1] + 1 : 0; m < (v && a[4] == D[0] ? +D[1] : 10); ++m) z.push(m)
                }
                return {
                    disabled: z,
                    length: i,
...
(function (a) {
    ...
    b.presets.numpad.date = function (c) {
        ...
        var i = a.extend(c.settings, b.datetime.defaults, d, j),
            k = i.dateOrder,
        ...
        k = "";
        for (j = 0; 8 > j; ++j)
            if (k += "d", j + 1 == g || j + 1 == f || j + 1 == h) k += i.delimiter;
        c.getVal = function (a) {
        ...
        return {
            ...
            parseValue: function (a) {
                ...
                if (c)
                    for (c = 0; c < o.length; ++c) e = /m/i.test(o[c].n) ? e.concat(((9 > i.getMonth(a) ? "0" : "") + (i.getMonth(a) + 1)).split("")) : /d/i.test(o[c].n) ? e.concat(((10 > i.getDay(a) ? "0" : "") + i.getDay(a)).split("")) : e.concat((i.getYear(a) + "").split(""));
                return e
            },
            formatValue: function (a) {
            ...
            validate: function (a) {
                ...
                if (a.length == f + 1) {
                    if (1 == a[f]) {
                        ...
                        if (F == s)
                            for (d = 0; d < +n[1]; ++d) v.push(d)
                    }
                    if (0 === a[f] && (v.push(0), r === s || F === s))
                        for (d = r === s ? +z > +D ? +q : +q + 1 : 0; d <= (F === s ? +n - 1 : 9); ++d) v.push(d)
                }
                if (a.length == h) {
                    for (d = T ? (10 <
                            +D ? +D[0] : 0) + 1 : +X[0] + 1; 9 >= d; ++d) v.push(d);
                    if (C)
                        for (d = 0; d < (10 > +A ? 0 : A[0]); ++d) v.push(d)
                }
                if (a.length == h + 1) {
                    if (3 <= a[h] || "02" == u)
                        for (d = +X[1] + 1; 9 >= d; ++d) v.push(d);
                    if (T && +D[0] == a[h])
                        for (d = +D[1] + 1; 9 >= d; ++d) v.push(d);
                    if (C && A[0] == a[h])
                        for (d = 0; d < +A[1]; ++d) v.push(d);
                    if (0 === a[h] && (v.push(0), T || C))
                        for (d = T ? +D + 1 : 1; d <= (C ? +A - 1 : 9); ++d) v.push(d)
                }
                if (void 0 !== a[g + 2] && "02" == u && "29" == z)
                    for (k = +("" + a[g] + a[g + 1] + a[g + 2] + 0); k <= +("" + a[g] + a[g + 1] + a[g + 2] + 9); ++k) v.push(!(0 === k % 4 && 0 !== k % 100 || 0 === k % 400) ? k % 10 : "");
                if (a.length == g) {
                    if (i.min)
                        for (d =
                            0; d < +F[0]; ++d) v.push(d);
                    if (i.max)
                        for (d = +r[0] + 1; 9 >= d; ++d) v.push(d);
                    v.push(0)
                }
                if (i.min || i.max)
                    for (k = 1; 4 > k; ++k)
                        if (a.length == g + k) {
                            if (a[g + k - 1] == +F[k - 1] && (3 == k ? a[g + k - 2] == +F[k - 2] : 1))
                                for (d = 0; d < +F[k] + (3 == k && a[f + 1] && +n > +u ? 1 : 0); ++d) v.push(d);
                            if (a[g + k - 1] == +r[k - 1] && (3 == k ? a[g + k - 2] == +r[k - 2] : 1))
                                for (d = +r[k] + (3 == k && +q < +u ? 0 : 1); 9 >= d; ++d) v.push(d)
                        }
                return {
                    disabled: v,
    ...
    g.Scroller = function (b, A, D) {
        ...
        function l(b, c,
            ...
            return {
                ...
                v: d ? k(b, ea,
                    ga) : b,
                val: h.hasClass("dw-v") || d ? h.attr("data-val") : null
            }
        }
        ...
        var R, S, G, P, Z, I, Q, V, K, ca, U, ha, ia, B, ea, ga, aa, da, ta, fa, L = this,
            wa = a(b),
            ma = {},
            ya = {},
            ka = {},
    ...
    b.datetime = {
        ...
        formatDate: function (d, c, e) {
            ...
            for (j = 0; j < d.length; j++)
                if (k) "'" == d.charAt(j) && !g("'") ? k = !1 : i += d.charAt(j);
                else switch (d.charAt(j)) {
                case "d":
                    i += f("d", e.getDay(c), 2);
                    break;
                case "D":
            ...
            var c = "object" == typeof c ? c.toString() : c + "",
                ...
                w = function (a, b, e) {
                    ...
                    for (b = 0; b < a.length; b++)
                        if (c.substr(M, a[b].length).toLowerCase() == a[b].toLowerCase()) return M += a[b].length, b + 1;
                    return 0
                },
                M = 0,
                t;
            for (t = 0; t < d.length; t++)
                if (D) "'" == d.charAt(t) && !F("'") ? D = !1 : M++;
    ...
    g.calbase = function (b) {
        function n(b, c, e) {
            ...
            b && a.each(b, function (a, b) {
                ...
                f = d + "";
                if (b.start && b.end)
                    for (g = new Date(b.start); g <= b.end;) h = new Date(g.getFullYear(), g.getMonth(), g.getDate()), i[h] = i[h] || [], i[h].push(b), g.setDate(g.getDate() + 1);
                else if (d.getTime) h = new Date(d.getFullYear(), d.getMonth(), d.getDate()), i[h] = i[h] || [], i[h].push(b);
                else if (f.match(/w/i)) {
                    var k = +f.replace("w", ""),
                        q = 0,
                ...
                } else if (f = f.split("/"), f[1]) 11 <= e + j && (h = x.getDate(c + 1, f[0] - 1, f[1]), i[h] = i[h] || [], i[h].push(b)), 1 >= e - j && (h = x.getDate(c - 1, f[0] - 1, f[1]), i[h] = i[h] || [], i[h].push(b)), h = x.getDate(c, f[0] - 1, f[1]), i[h] = i[h] || [], i[h].push(b);
                else
                    for (E = 0; E < Ga; E++) h = x.getDate(c, e - pa - na + E, f[0]), i[h] = i[h] || [], i[h].push(b)
            });
            return i
        }
        ...
        function D(e, d) {
            var f, h, g, i, j, q, l, p, n, o, I, B, m, E, A = 1,
                r = 0;
            f = x.getDate(e, d, 1);
            var y = x.getYear(f),
                ya = x.getMonth(f),
        ...
        function F(b, c, e) {
            ...
            if (ab) {
                ...
                if (f === ma)
                    for (p = 0; p < ka; p++) a('.dw-cal-month-s[data-val="' + p + '"]', G).addClass("dwb-d");
                if (f === ya)
                    for (p = qa + 1; 12 >= p; p++) a('.dw-cal-month-s[data-val="' + p + '"]', G).addClass("dwb-d")
            }
        ...
        function N(c, e, d, f, h, g, i) {
            ...
            if (!Za) {
                ...
                q(c, e);
                if (h)
                    for (p = 0; p < la; p++) xa[d ? Ga - la + p : p].html(D(c, e - na + p));
                        ...
                        setTimeout(function () {
                            ...
                            if (xa.length) {
                                ...
                                if (d) {
                                    ...
                                    g = xa.splice(Ga - f, f);
                                    for (p = f - 1; 0 <= p; p--) xa.unshift(g[p]), s(xa[0], +xa[1].data("curr") - 100 * gb)
                                }
        ...
        var O, p, E, R, S, G, P, Z, I, Q, V, K, ca, U, ha, ia, B, ea, ga, aa, da, ta, fa, L, wa, ma, ya, ka, qa, oa, La, hb, za, Ba, ra, ja, ob, pb, Eb, Ka, Ra, Wa, Za, Sa, la, Ga, Ja, na, Xa, Va, cb, sb, Gb = this,
            Aa = [],
            xa = [],
            fb = [],
            va = {},
        ...
        a.extend(R, {
            ...
            onPosition: function (c,
                ...
                if (Ha && zb) {
                    ...
                    h && ca && Ra.height(va.calendar.height());
                    c = S.height();
                    d >= c && Z.height(d - c + Z.height());
                    ca && (j = Math.max(j, va.calendar.height()))
                }
                if (h) {
                    Ra.css({
                        width: Ha ? "" : i,
            ...
            onValidated: function () {
                ...
                if (K) a = "calendar";
                    ...
                    for (e in b.order) e && b.order[e] === p && (a = /mdy/.test(e) ? "date" : "time");
                b.trigger("onSetDate", [{
                    date: c,
                    control: a
                }]);
    ...
    a.mobiscroll.presets.scroller.list = function (c) {
        ...
        function f(a, c, e) {
            ...
            for (; d < a.length;) {
                ...
                if (c !== b && q[c].children) d++, q = q[c].children;
                else if ((g = h(q)) && g.children) d++, q = g.children;
                else break
            }
            return i
        }
        ...
        var n = a.extend({}, c.settings),
            q = a.extend(c.settings, d,
                n),
            n = q.layout || (/top|bottom/.test(q.display) ? "liquid" : ""),
            A = "liquid" == n,
            D = q.readonly,
            F = a(this),
            r, w, M = this.id + "_dummy",
            t = 0,
            m = 0,
            H = {},
            N, v = [],
    ...
    c.ScrollView = function (e, d, M) {
        ...
        function m(a) {
            if (I) {
                ...
                !Z && 5 < Math.abs(J) && (L.scrolled = !0, ka.liveSwipe && !K && (K = !0, V = D(H)));
        ...
        function u(a, b, c) {
            ...
            Q = !0;
            if (j)
                if (aa[f + "Transition"] = b ? h + "transform " + Math.round(b) + "ms " + ka.easing : "", aa[f + "Transform"] = "translate3d(" + (fa ? "0," + a + "px," : a + "px,0,") + "0)", wa == a || !b) e();
                else {
    ...
    var d = a.mobiscroll,
        ...
        f = function (e) {
            ...
            function n(a, b) {
                ...
                e = c = a;
                if (2 !== b)
                    for (d = q(c); !d && c < aa;) c = new Date(c.getTime() + 864E5), d = q(c), h++;
                if (1 !== b)
                    for (f = q(e); !f && e > ga;) e = new Date(e.getTime() - 864E5), f = q(e), g++;
                return 1 ===
            ...
            function D(a, b, c, e, d, f, h) {
                ...
                if (a)
                    for (g = 0; g < a.length; g++)
                        if (i = a[g], j = i + "", !i.start)
                            if (i.getTime) y.getYear(i) == b && y.getMonth(i) == c && (f[y.getDay(i) - 1] = h);
                            else if (j.match(/w/i)) {
                    j = +j.replace("w", "");
            ...
            function F(c, e, d, f, h, g, j, q, k) {
                var n, o, I, m, A, D, s, G, S, E, t, F, L, u, v, z, K, U, Q = {},
                    w = {
                        h: ia,
                        i: B,
                        s: ea,
                ...
                c && (a.each(c, function (a, b) {
                    ...
                    if (f.start && (f.apply || !f.d && !Q[H])) {
                        ...
                        if (!k)
                            for (E = e + 1; 4 > E; E++) 0 < m[E] && (L = w[d]), A[E] < J[C[E]] && (u = w[d]);
            ...
            if (N.match(/date/i)) {
                a.each(["y", "m", "d"], function (a, b) {
                    v = I.search(RegExp(b, "i")); - 1 < v && E.push({
                        o: v,
                        v: b
                    })
                });
            ...
            if (N.match(/time/i)) {
                ...
                a.each(["h", "i", "s", "a"], function (a, b) {
                    a = Q.search(RegExp(b, "i")); - 1 < a && E.push({
                        o: a,
                        v: b
                    })
                });
...
(function (a, b) {
    ...
    d.presets.scroller.measurement = function (e) {
        ...
        if (T)
            if (T = !1, l)
                for (fa = 0; fa < M.units.length; fa++) 0 > n(M.min, J, M.units[fa]) && (T = !0);
            else T = 0 > M.min;
        T && (t[0].push({
            values: ["-", "+"],
            label: M.signText
...
(function (a, b, d, c) {
    ...
    j.calendar = function (d) {
        ...
        if (p.selectedValues)
            for (C = 0; C < p.selectedValues.length; C++) Q[F(p.selectedValues[C])] = p.selectedValues[C];
        ...
        g(J, {
            ...
            onDayChange: function (b) {
                ...
                if (V) {
                    ...
                    if (p.selectType == "week") {
                        var h, g, j = e.getDay() - X,
                            j = j < 0 ? 7 + j : j;
                        p.multiSelect || (Q = {});
                        for (h = 0; h < 7; h++) {
...
(function (a, b) {
    ...
    d.presets.scroller.timespan = function (e) {
        ...
        var j, o, i, k, n, q, A, D, F, r, w, M, t, m, H = a.extend({}, e.settings),
            ...
            T = "seconds",
            l = 0,
            J = N.defaultValue || Math.max(N.minTime,
                Math.min(0, N.maxTime)),
            y = [[]];
        i = 0;
        D = g(i);
        t = g(N.minTime);
        ...
        a(s).each(function (a, b) {
            o = v.search(RegExp(u[b].re, "i")); - 1 < o && (z.push({
                o: o,
                v: b
            }), u[b].index > u[T].index && (T = b))
        });
        z.sort(function (a, b) {
            return a.o > b.o ? 1 : -1
        });
...
(function (a) {
    ...
    d.temperature = function (b) {
        var h = a.extend({}, c, b.settings),
            ...
            k, n;
        if (h.units)
            for (n = 0; n < h.units.length; n++) k = h.units[n], e[k] && (o.push(k), i.push(h.unitNames[k] || k));
...
(function (a) {
    ...
    d.mass = function (b) {
        var f = a.extend({}, c, b.settings),
            ...
            i, k;
        if (f.units)
            for (k = 0; k < f.units.length; k++) i = f.units[k],
...
(function (a) {
    ...
    d.force = function (b) {
        var f = a.extend({}, c, b.settings),
            ...
            o, i;
        if (f.units)
            for (i = 0; i < f.units.length; i++) o = f.units[i], e[o] && j.push(o);
        a.extend(b.settings, f, {
            sign: !1,
            units: j,
            unitNames: null,
...
(function (a, b, d, c) {
    ...
    f.MenuStrip = function (d, j) {
        ...
        var F, r, w, M,
            t, m, H, N, v, s, u, z, X, C, T, l, J, y, O = this,
            p = a(d);
    ...
    d.presets.scroller.timer = function (d) {
        ...
        return {
            ...
            validate: function (c, g, i) {
                ...
                if (G && 0 === g) c = !0, j = f(F);
                else if (!N && (n[0] < t || n[0] > m)) j = f(w ? r : F - r), c = !0;
...
(function (a, b) {
    ...
    c.range = c.rangepicker = function (d) {
        ...
        var n, q, A, D, F, r, w, M, t, m, H, N, v, s, u, z = d._startDate,
            X = d._endDate,
            C = 0;
        F = new Date;
        var T = a.extend({}, d.settings),
            ...
            E = "dw-cal-day-hl",
            R = null === l.defaultValue ? [] : l.defaultValue || [new Date(F.setHours(0, 0, 0, 0)), new Date(F.getFullYear(), F.getMonth(), F.getDate() + 6, 23, 59, 59, 999)];
        y && (l.tabs = !0);
        ...
        d.getDayProps = function (a) {
            var b = m ? new Date(m.getFullYear(), m.getMonth(),
                    m.getDate()) : null,
                c = H ? new Date(H.getFullYear(), H.getMonth(), H.getDate()) : null;
            return {
        ...
        a.extend(F, {
            ...
            onSetDate: function (c) {
                ...
                d._isValid = o(w || A || l.autoCorrect, !r);
...
(function (a) {
    ...
    d.speed = function (b) {
        var f = a.extend({}, c, b.settings),
            ...
            i, k;
        if (f.units)
            for (k = 0; k < f.units.length; k++) i = f.units[k], e[i] && (j.push(i), o.push(f.unitNames[i] || i));
        a.extend(b.settings, f, {
            sign: !1,
            units: j,
            unitNames: o,
...
(function (a, b) {
    ...
    d.presets.scroller.rating = function (e) {
        ...
        if (a.isArray(f.values))
            for (D = 0; D < f.values.length; D++) r = +f.values[D], isNaN(r) && (r = D + 1, A = !0), n.push({
                order: r,
                key: f.values[D],
                value: f.values[D]
            });
        else if (a.isPlainObject(f.values))
            for (F in D = 1, A = !0, f.values) r = +F, isNaN(r) && (r = D), n.push({
                order: r,
                key: F,
                value: f.values[F]
            }), D++;
        else
            for (D = 1; D <= f.values; D++) n.push({
                order: D,
                key: D,
                value: D
            });
        f.showText === b && A && (f.showText = !0);
...
(function (a, b) {
    ...
    d.presets.scroller.select = function (d) {
        ...
        var D, F, r, w, M, t, m, H, N, v, s, u, z, X, C, T = {},
            l = {},
            J = {},
            y = {},
            O = {},
...
(function (a) {
    ...
    mobiscroll.ko = {
        preventUpdate: {},
        getShortHandEventsObject: function (a) {
            return {
        ...
        getInitObject: function (b, c) {
            var e = b()["mobiscroll.options"] || {},
                g = b()["mobiscroll.event"] || {};
            a.extend(e, c ? "string" === typeof c ? {
                preset: c
            } : c : {}, g, mobiscroll.ko.getShortHandEventsObject(b()));
            return e
        },
...
(function (a) {
    ...
    mobiscroll.ember = {
        preventUpdate: {},
        getEmberMobiscrollView: function (a, e, g, f, h, j, o) {
            var i = f || mobiscroll.ember.defaultMarkupTemplate,
                k = h === null ? null : h || "input",
                n =
                a instanceof Function ? a : mobiscroll.ember.generalInitFn,
                f = f && f("").layout ? {
                    layout: function () {}
                } : {
                    template: function () {}
            ...
            return Ember.View.extend(f, {
                init: function () {
                    ...
                    else if (a.layout) this.layout = a.layout
                },
                options: "",
                value: "",
...
(function (a) {
    ...
    mobiscroll.kendo.getMobiBinder = function (b, d, c, e, g, f) {
        ...
        function o(c, e, f) {
            ...
            var f = mobiscroll.kendo.getMobiInitObject(c, e, b, d, g),
                h = this;
    ...
    mobiscroll.kendo.getMobiInitObject = function (b, d, c, e, g) {
        ...
        return a.extend(!0, "string" === typeof e ? {
            preset: e
        } : e, f, g || {})
    };
...
(function (a) {
    ...
    ko.bindingHandlers["mobiscroll.listview"] = {
        ...
        update: function (d, c, e, g, f) {
            ...
            }), a(d).mobiscroll().listview(e);
            else if (g.length && void 0 !== b[g[0].id] && a(d).parents(".mbsc-lv-cont").length && a(d).parent().hasClass("mbsc-lv-item")) {
                var h = a(d);
...
(function () {
    ko.bindingHandlers["mobiscroll.numpad"] = {
        init: function (a, b, d, c, e) {
            mobiscroll.ko.initializeGenericComponent(a, b, d, c, e, {
                component: "Numpad"
            }, null)
        },
        update: mobiscroll.ko.updateGenericComponent
...
(function () {
    ko.bindingHandlers["mobiscroll.rangepicker"] = ko.bindingHandlers["mobiscroll.range"] = {
        init: function (a, b, d, c, e) {
            var g = {
                onDayChange: d()["mobiscroll.onDayChange"],
                onMonthChange: d()["mobiscroll.onMonthChange"]
            };
...
(function () {
    ...
    angular.module("mobiscroll-listview", e).directive("mobiscrollListviewItem", ["$rootScope", "$compile", "$timeout", function (a, b, c) {
        ...
        return {
            link: function (e, g, k) {
                var n = g.parent(),
                    q = n.parent().hasClass("mbsc-lv-ng-initialized");
        ...
        return {
            ...
            compile: function (e) {
                var h = c++,
                    n = $($.parseHTML($.trim(e.html().replace(/(mbsc-ng-)|(ms-ng-)/g, "ng-"))));
...
(function () {
    ...
    angular.module("mobiscroll-numpad", []).directive("mobiscrollNumpad", ["$parse", function (b) {
        return mobiscroll.ng.getDDO(b, "mobiscrollNumpad", {
            component: "Numpad"
        }, null, a)
    }])
})(Zepto);
...
(function () {
    ...
    angular.module("mobiscroll-menustrip", []).directive("mobiscrollRepeatRender", function () {
        ...
        var c = mobiscroll.ng.getDDO(b, "mobiscrollMenustrip", {
            component: "MenuStrip"
        }, function () {}, function () {});
...
(function () {
    ...
    angular.module("mobiscroll-timer", []).directive("mobiscrollTimer", ["$parse", function (c) {
        return mobiscroll.ng.getDDO(c, "mobiscrollTimer", {
            preset: "timer"
        }, b, a, d)
    }])
})(Zepto);
(function () {
    angular.module("mobiscroll-colorpicker", []).directive("mobiscrollColorpicker", ["$parse", function (a) {
        return mobiscroll.ng.getDDO(a, "mobiscrollColorpicker", {
            preset: "colorpicker"
        })
    }]);
...
(function () {
    angular.module("mobiscroll-rangepicker", []).directive("mobiscrollRangepicker", ["$parse", function (a) {
        return mobiscroll.ng.getDDO(a, "mobiscrollRangepicker", {
            preset: "rangepicker"
        })
    }]);
...
(function (a) {
    angular.module("mobiscroll-select", []).directive("mobiscrollSelectOption", function () {
        ...
        var d = mobiscroll.ng.getDDO(b, "mobiscrollSelect", {
            preset: "select"
        });
        d.link = void 0;
        d.compile = function (c) {
            for (var d = !1, c = a(c).find("option"), g = 0; g < c.length; g++)
                if (a(c[g]).attr("ng-repeat") ||
...
(function () {
    ...
    angular.module("mobiscroll-list", []).directive("mobiscrollRepeatRender", function () {
        ...
        var d = mobiscroll.ng.getDDO(b, "mobiscrollList", {
            preset: "list"
        });
        d.compile = function (c) {
            var d, g;
...
(function () {
    ...
    angular.module("mobiscroll-image", []).directive("mobiscrollRepeatRender", function () {
        ...
        var d = mobiscroll.ng.getDDO(b, "mobiscrollImage", {
            preset: "image"
        });
        d.compile = function (c) {
            var d, g;
        ...
        function e(a, b, c, d) {
            ...
            if (c.length && a)
                for (var g = 0; g < c.length; g++) {
                    ...
                    if (!k.length) {
                        var n = $(c[g]).data("ref"),
                            n = d.find('li.mbsc-lv-back[data-back="' + n + '"]');
                        n.length && (k = n.parent("ul"))
                    }
                    var n = a.at(g).get("children"),
                        q = !1;
                    if (k.length && n) q = e(n, b, k, d);
                    else if (!k.length && n == b) return $(c[g]);
                    if (q) return q
                }
            return !1
        }
            ...
            initialize: function () {
                ...
                d.on("add mobiscrollListviewAddChild", function (a, g) {
                    var o = c.html(),
                        ...
                        k = this.$el.find(b),
                        n = e(d, g, k, k.closest(".mbsc-lv-cont"));
...
(function (a) {
    mobiscroll.ember.listItemHelper = function () {
        return Ember.View.extend({
            ...
            didInsertElement: function () {
                var a = this.$(),
                    d = this.get("dataAttributeBindings");
                if (d && (d = d.replace(/\s{2,}/g, " "), (d = d.split(" ")).length))
                    for (var c = 0; c < d.length; c++) {
                        var e = d[c].split(":"),
                            g = e[0],
                            f = this.get("content." + g);
                        2 == e.length && (g = e[1]);
                        a.attr("data-" + g, f)
                    }
            },
    ...
    mobiscroll.ember.listHelper = function () {
        return Ember.CollectionView.extend({
            ...
            removing: null,
            arrayWillChange: function (a, d, c) {
            ...
            arrayDidChange: function (a,
                ...
                if (this.isInitialized())
                    if (0 < e) Ember.run.scheduleOnce("afterRender", this, function () {
...
(function () {
    ...
    mobiscroll.ember.eventCalendar = function () {
        return mobiscroll.ember.getEmberMobiscrollView("calendar", a, function () {}, void 0, void 0, {
            events: []
        }, {
            willChange: function () {},
            didChange: a
...
(function (a) {
    kendo.data.binders["mobiscroll-listview"] = kendo.data.binders.source.extend({
        init: function (b, d, c) {
            ...
            var e = a(b).data("mobiscroll-options"),
                g = {};
        ...
        refresh: function (b) {
            if (b && "remove" == b.action) b = a(this.element).find("li:eq(" + b.index + ")"), a(this.element).mobiscroll("remove", b);
            else if (b && "itemchange" == b.action && (b.action =
                    void 0), kendo.data.binders.source.fn.refresh.call(this, b), b && "add" == b.action) {
                var d = b.index,
                    b = a(this.element).find("li:eq(" + d + ")");
...
(function () {
    kendo.data.binders["mobiscroll-numpad"] = kendo.data.Binder.extend(mobiscroll.kendo.getMobiBinder("mobiscroll-numpad", {
        component: "Numpad"
    }))
})();
(function () {
...
(function () {
    kendo.data.binders["mobiscroll-menustrip"] = kendo.data.Binder.extend(mobiscroll.kendo.getMobiBinder("mobiscroll-menustrip", {
        component: "MenuStrip"
    }))
})();
(function () {
    kendo.data.binders["mobiscroll-widget"] = kendo.data.Binder.extend(mobiscroll.kendo.getMobiBinder("mobiscroll-widget", {
        component: "Widget"
    }))
})();
(function (a) {
    ...
    kendo.data.binders["mobiscroll-timer"] = kendo.data.Binder.extend(mobiscroll.kendo.getMobiBinder("mobiscroll-timer", "timer", function (d, c) {
        if (!b[d.id] && c) {
            var e = a(d),
                g = e.mobiscroll("setEllapsedTime", c).mobiscroll("getInst");
            e.val(g._value)
        }
        b[d.id] = !1
    }, function (d, c, e) {
...
(function () {
    kendo.data.binders["mobiscroll-select"] = kendo.data.Binder.extend(mobiscroll.kendo.getMobiBinder("mobiscroll-select", "select", void 0, void 0, void 0, function (a, b, d) {
        ...
        var c = $(a).data("mobiscroll-options"),
            d = {};
